...
namespace AgileTourTaipei2016
{
    ...
    public class Iteration1Steps
    {
        ...
        [Given(@"一件 衣服 原價 (.*) the price after using coupon code is (.*)")]
        public void Given一件衣服原價ThePriceAfterUsingCouponCodeIs(int p0, int p1)
        {
        }
        
        [Given(@"一件 褲子 原價 (.*) the price after using coupon code is (.*)")]
        public void Given一件褲子原價ThePriceAfterUsingCouponCodeIs(int p0, int p1)
        {
        }
