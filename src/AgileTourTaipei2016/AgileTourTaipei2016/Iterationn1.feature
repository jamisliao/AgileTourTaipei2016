...
Scenario: 購買一件商品，家電類，結帳金額超過送折價券門檻，送200折價券
...
Scenario: 購買三件商品，包含服飾類與家電類，結帳金額超過送折價券門檻，送1200折價券
	Given 一件 衣服 原價 2500 折扣完後價格為 2000
	Given 一件 褲子 原價 4000 折扣完後價格為 3200
	Given 一台 電視 原價 20000 折扣完後價格為 17000
	When 當結帳完成後
...
Scenario: 購買兩件商品，包含精品類與未參加活動專櫃，結帳金額超過送折價券門檻，送1500折價券
	Given 一個 Gucci 精品包包 原價 40000 折扣完後價格為 35000
	Given 一個 LV 精品包包 原價 50000 折扣完後價格為 46000
	When 當結帳完成後
	Then 需要送 1500元折價券

Scenario: 購買兩件商品，服飾類，使用折價券，結帳金額超過送折價券門檻，送400折價券
	Given 一件 衣服 原價 2500 折扣完後價格為 2000
	Given 一件 褲子 原價 4000 折扣完後價格為 3200
	Given 使用折價券 折抵 500
	When 當結帳完成後
...
Scenario: 購買一件商品，服飾類，使用Coupon Code，結帳金額超過送折價券門檻，送200折價券
	Given 一件 衣服 原價 2500 使用Coupon Code折扣完後價格為 2000
	When 當結帳完成後
	Then 需要送 200元折價券

Scenario: 購買三件商品，服飾類，精品類,家電類 使用Coupon Code，結帳金額超過送折價券門檻，送200折價券
	Given 一件 衣服 原價 2500   使用Coupon Code折扣完後價格為 2000 送200
	Given 一件 包包 原價 30000  折扣完後價格為 24000 送1000  
	Given 一件 冰箱 原價 30000  折扣完後價格為 24000 送800
	When 當結帳完成後 28400
	Then 需要送2000 元